...
Names here are the names used in the code. This table covers only the
...
deletes the original entry. This keeps the append-only guarantee
intact: the full history of "what this person was charged, and why it
